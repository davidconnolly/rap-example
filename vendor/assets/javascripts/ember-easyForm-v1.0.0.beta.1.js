...
(function () {
  Ember.TEMPLATES['easyForm/input'] = Ember.Handlebars.template(function anonymous(Handlebars, depth0, helpers, partials, data) {
    ...
    hashContexts = {'propertyBinding': depth0, 'textBinding': depth0, 'translationBinding': depth0, 'classNames': depth0};
    hashTypes = {'propertyBinding': "STRING", 'textBinding': "STRING", 'translationBinding': "STRING", 'classNames': "STRING"};
    options = {hash: {
      'propertyBinding': ("view.property"),
      'textBinding': ("view.label"),
      'translationBinding': ("view.translation"),
      'classNames': ("col-sm-2")
...
(function () {
  Ember.TEMPLATES['easyForm/wrapped_input'] = Ember.Handlebars.template(function anonymous(Handlebars, depth0, helpers, partials, data) {
    ...
    hashContexts = {'propertyBinding': depth0, 'textBinding': depth0, 'translationBinding': depth0};
    hashTypes = {'propertyBinding': "STRING", 'textBinding': "STRING", 'translationBinding': "STRING"};
    options = {hash: {
      'propertyBinding': ("view.property"),
      'textBinding': ("view.label"),
      'translationBinding': ("view.translation")
